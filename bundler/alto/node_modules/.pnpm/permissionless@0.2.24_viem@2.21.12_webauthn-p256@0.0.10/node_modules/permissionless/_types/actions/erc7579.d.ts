...
export type Erc7579Actions<TSmartAccount extends SmartAccount | undefined> = {
    ...
    installModule: <callsType extends readonly unknown[]>(args: InstallModuleParameters<TSmartAccount, callsType>) => Promise<Hash>;
    installModules: <callsType extends readonly unknown[]>(args: InstallModulesParameters<TSmartAccount, callsType>) => Promise<Hash>;
    ...
    uninstallModule: <callsType extends readonly unknown[]>(args: UninstallModuleParameters<TSmartAccount, callsType>) => Promise<Hash>;
    uninstallModules: <callsType extends readonly unknown[]>(args: UninstallModulesParameters<TSmartAccount, callsType>) => Promise<Hash>;
};
