...
export type UninstallModuleParameters<TSmartAccount extends SmartAccount | undefined, calls extends readonly unknown[]> = GetSmartAccountParameter<TSmartAccount> & {
    type: ModuleType;
    address: Address;
    maxFeePerGas?: bigint;
...
export declare function uninstallModule<TSmartAccount extends SmartAccount | undefined, calls extends readonly unknown[]>(client: Client<Transport, Chain | undefined, TSmartAccount>, parameters: UninstallModuleParameters<TSmartAccount, calls>): Promise<Hex>;
