...
const erc20AllowanceOverride_js_1 = require("../../../utils/erc20AllowanceOverride.js");
...
const prepareUserOperationForErc20Paymaster = (pimlicoClient, { balanceOverride = false, balanceSlot: _balanceSlot, allowanceSlot: _allowanceSlot } = {}) => async (client, parameters_) => {
    ...
    if (typeof paymasterContext === "object" &&
        ...
        const balanceStateOverride = balanceOverride && hasBalanceSlot
            ...
            : undefined;
        const allowanceStateOverride = balanceOverride && hasAllowanceSlot
            ? (0, erc20AllowanceOverride_js_1.erc20AllowanceOverride)({
                token,
                owner: account.address,
