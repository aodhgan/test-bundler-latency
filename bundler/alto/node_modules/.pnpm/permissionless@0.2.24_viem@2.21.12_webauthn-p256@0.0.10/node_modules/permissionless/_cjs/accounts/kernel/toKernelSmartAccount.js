...
const getValidatorData = async (owner) => {
    ...
    if ((0, isWebAuthnAccount_js_1.isWebAuthnAccount)(owner)) {
        const parsedPublicKey = (0, webauthn_p256_1.parsePublicKey)(owner.publicKey);
        const authenticatorIdHash = (0, viem_1.keccak256)((0, webauthn_p256_1.bytesToHex)((0, webauthn_p256_1.base64UrlToBytes)(owner.id)));
...
const getAccountInitCode = async ({ entryPointVersion, kernelVersion, validatorData, index, factoryAddress, accountLogicAddress, validatorAddress }) => {
