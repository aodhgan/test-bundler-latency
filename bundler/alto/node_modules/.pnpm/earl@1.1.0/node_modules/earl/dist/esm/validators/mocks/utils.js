...
import { isMockFn } from '../../mocks/index.js';
export function assertIsMock(control) {
...
export function formatCalledTimes(mock) {
    return mock.calls.length === 0
        ? 'never called'
        : `called ${formatTimes(mock.calls.length)}`;
}
export function compareArgs(control, actual, expected) {
