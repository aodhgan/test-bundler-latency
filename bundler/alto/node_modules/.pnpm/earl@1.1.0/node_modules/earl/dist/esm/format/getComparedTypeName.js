...
export function getComparedTypeName(value, sibling, type, ignorePrototypes) {
...
export function getTypeName(value, ignorePrototypes) {
...
export function getFunctionTypeName(value) {
