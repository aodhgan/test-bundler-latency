...
export function formatMapEntries(value, sibling, options, valueStack, siblingStack) {
    ...
    for (let i = 0; i < valueItems.length; i++) {
        const keyFormat = formatUnknown((_a = valueItems[i]) === null || _a === void 0 ? void 0 : _a[0], (_b = siblingItems[i]) === null || _b === void 0 ? void 0 : _b[0], keyOptions, valueStack, siblingStack);
        ...
        const valueFormat = formatUnknown((_d = valueItems[i]) === null || _d === void 0 ? void 0 : _d[1], (_e = siblingItems[i]) === null || _e === void 0 ? void 0 : _e[1], valueOptions, valueStack, siblingStack);
